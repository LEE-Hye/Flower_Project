    ...
    <div class="header-section">
        <div class="row">
            <div class="col-md-5 col-sm-5">
                <div class="logo-img">
                    <a href="main.html"><img id="main_pic" src="images/client/5055151.jpg" class="img-responsive" alt=""></a>
                </div>
            </div>
        ...
        <div class="navbar navbar-default navbar-top">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="active" href="post_view.html">커뮤니티</a>
                    </li>
                <!-- 네비게이션 끝 -->
            </div>
        </div>
            ...
            <h4>글을 작성하는 공간입니다.</h4>
                <div id="write_area">
                    <form enctype="multipart/form-data" action="write_ok.php?board_id=<?echo $board_id;?>" method="post">
                        ...
                        <div id="in_content">
                            <textarea name="content" id="ucontent" rows="20" cols="160" maxlength="2000" placeholder="내용" required></textarea>
